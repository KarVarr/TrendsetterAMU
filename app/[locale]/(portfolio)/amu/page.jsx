...
import ModernPortfolioPageClient from './ModernPortfolioPageClient';
...
export default function ModernPortfolioPage(props) {
  return <ModernPortfolioPageClient {...props} />;
}